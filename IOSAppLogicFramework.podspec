#
#  Be sure to run `pod spec lint IOSAppLogicFramework.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.version      = "0.0.1"
  spec.summary      = "A short description of IOSAppLogicFramework."
  ...
  spec.framework  = "FBSDKCoreKit"
  # spec.frameworks = "FBSDKCoreKit", "AnotherFramework"
